...
import os
os.chdir("/Users/Zoe.Su/Documents/Zoe的学习资料/Python/100 days of Code- The Complete Python Pro Bootcamp for 2023/exercise code/day-86-typing-speed-test/typing_speed_test_ver2")
...
LOGO_IM = Image.open('/Users/Zoe.Su/Documents/Zoe的学习资料/Python/100 days of Code- The Complete Python Pro Bootcamp for 2023/exercise code/day-86-typing-speed-test/typing_speed_test_ver2/assets/typing-speed-test.png')
...
LANGUAGES = [
    {
        'name':'EN', 
        'logo': '/Users/Zoe.Su/Documents/Zoe的学习资料/Python/100 days of Code- The Complete Python Pro Bootcamp for 2023/exercise code/day-86-typing-speed-test/typing_speed_test_ver2/assets/EN.png', 
        'font': 'Tahoma', 
        ...
        'name':'JP', 
        'logo': '/Users/Zoe.Su/Documents/Zoe的学习资料/Python/100 days of Code- The Complete Python Pro Bootcamp for 2023/exercise code/day-86-typing-speed-test/typing_speed_test_ver2/assets/JP.png', 
        ...
        'name':'CN', 
        'logo': '/Users/Zoe.Su/Documents/Zoe的学习资料/Python/100 days of Code- The Complete Python Pro Bootcamp for 2023/exercise code/day-86-typing-speed-test/typing_speed_test_ver2/assets/CN.png', 
        'font': 'Arial Unicode.ttf',
        'msg1': "你的手速几何？来试试限时60秒的打字测试就知道咯！\n按空格键结束每个单词的输入，倒计时结束后，可以确认你实际的打字速度哦～\n祝你好运\n", 
        'msg2': "最新成绩：", 
        'msg3': "在此输入单词开始测试", 
        'msg4': '提示',
